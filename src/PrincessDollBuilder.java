public class PrincessDollBuilder implements DollBuilder {
    private Doll doll;

    public PrincessDollBuilder() {
        this.reset();
    }
    ...
    public DollBuilder reset() {
        this.doll = new Doll();
        this.doll.setOutfit("Royal Dress");
        return this;
    }
    ...
    public Doll build() {
        if (this.doll.getName() == null || this.doll.getName().trim().isEmpty()) {
            throw new IllegalStateException("Princess Doll must have a name!");
        }
